...
//
//     final myOrderModel = paymentOrderFromJson(jsonString);

import 'dart:convert';

PaymentOrder paymentOrderFromJson(String str) =>
    PaymentOrder.fromJson(json.decode(str));

String paymentOrderToJson(PaymentOrder data) => json.encode(data.toJson());
