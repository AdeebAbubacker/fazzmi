  ...
  factory ProductDetailModel.fromJson(Map<String, dynamic> json) =>
      ProductDetailModel(
        ...
        productLinks: json["product_links"] == null
            ? null
            : List<dynamic>.from(json["product_links"].map((x) => x)),
        options: json["options"] == null
            ? null
            : List<dynamic>.from(json["options"].map((x) => x)),
        mediaGalleryEntries: json["media_gallery_entries"] == null
            ? null
            : List<MediaGalleryEntry>.from(json["media_gallery_entries"]
                .map((x) => MediaGalleryEntry.fromJson(x))),
        tierPrices: json["tier_prices"] == null
            ? null
            : List<dynamic>.from(json["tier_prices"].map((x) => x)),
...
class ExtensionAttributes {
  ...
  factory ExtensionAttributes.fromJson(Map<String, dynamic> json) =>
      ExtensionAttributes(
        websiteIds: json["website_ids"] == null
            ? null
            : List<int>.from(json["website_ids"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "category_links": categoryLinks == null
            ? null
...
class StockItem {
  ...
  factory StockItem.fromJson(Map<String, dynamic> json) => StockItem(
        ...
        isQtyDecimal:
            json["is_qty_decimal"] == null ? null : json["is_qty_decimal"],
        showDefaultNotificationMessage:
            json["show_default_notification_message"] == null
                ? null
                : json["show_default_notification_message"],
        useConfigMinQty: json["use_config_min_qty"] == null
            ? null
            : json["use_config_min_qty"],
        minQty: json["min_qty"] == null ? null : json["min_qty"],
        useConfigMinSaleQty: json["use_config_min_sale_qty"] == null
            ? null
            : json["use_config_min_sale_qty"],
        minSaleQty: json["min_sale_qty"] == null ? null : json["min_sale_qty"],
        useConfigMaxSaleQty: json["use_config_max_sale_qty"] == null
            ? null
            : json["use_config_max_sale_qty"],
        maxSaleQty: json["max_sale_qty"] == null ? null : json["max_sale_qty"],
        useConfigBackorders: json["use_config_backorders"] == null
            ? null
            : json["use_config_backorders"],
        backorders: json["backorders"] == null ? null : json["backorders"],
        useConfigNotifyStockQty: json["use_config_notify_stock_qty"] == null
            ? null
            : json["use_config_notify_stock_qty"],
        notifyStockQty:
            json["notify_stock_qty"] == null ? null : json["notify_stock_qty"],
        useConfigQtyIncrements: json["use_config_qty_increments"] == null
            ? null
            : json["use_config_qty_increments"],
        qtyIncrements:
            json["qty_increments"] == null ? null : json["qty_increments"],
        useConfigEnableQtyInc: json["use_config_enable_qty_inc"] == null
            ? null
            : json["use_config_enable_qty_inc"],
        enableQtyIncrements: json["enable_qty_increments"] == null
            ? null
            : json["enable_qty_increments"],
        useConfigManageStock: json["use_config_manage_stock"] == null
            ? null
            : json["use_config_manage_stock"],
        manageStock: json["manage_stock"] == null ? null : json["manage_stock"],
        lowStockDate: json["low_stock_date"],
        isDecimalDivided: json["is_decimal_divided"] == null
            ? null
            : json["is_decimal_divided"],
        stockStatusChangedAuto: json["stock_status_changed_auto"] == null
            ? null
            : json["stock_status_changed_auto"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "use_config_min_sale_qty":
            useConfigMinSaleQty == null ? null : useConfigMinSaleQty,
        "min_sale_qty": minSaleQty == null ? null : minSaleQty,
        "use_config_max_sale_qty":
            useConfigMaxSaleQty == null ? null : useConfigMaxSaleQty,
        "max_sale_qty": maxSaleQty == null ? null : maxSaleQty,
        "use_config_backorders":
            useConfigBackorders == null ? null : useConfigBackorders,
        "backorders": backorders == null ? null : backorders,
        "use_config_notify_stock_qty":
            useConfigNotifyStockQty == null ? null : useConfigNotifyStockQty,
        "notify_stock_qty": notifyStockQty == null ? null : notifyStockQty,
        "use_config_qty_increments":
            useConfigQtyIncrements == null ? null : useConfigQtyIncrements,
        "qty_increments": qtyIncrements == null ? null : qtyIncrements,
        "use_config_enable_qty_inc":
            useConfigEnableQtyInc == null ? null : useConfigEnableQtyInc,
        "enable_qty_increments":
            enableQtyIncrements == null ? null : enableQtyIncrements,
        "use_config_manage_stock":
            useConfigManageStock == null ? null : useConfigManageStock,
        "manage_stock": manageStock == null ? null : manageStock,
        "low_stock_date": lowStockDate,
        "is_decimal_divided":
            isDecimalDivided == null ? null : isDecimalDivided,
        "stock_status_changed_auto":
            stockStatusChangedAuto == null ? null : stockStatusChangedAuto,
      };
}
