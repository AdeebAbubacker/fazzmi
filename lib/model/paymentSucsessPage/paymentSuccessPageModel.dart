...
//
//     final payementSuccessPageModel = payementSuccessPageModelFromJson(jsonString);

import 'dart:convert';

PayementSuccessPageModel payementSuccessPageModelFromJson(String str) =>
    PayementSuccessPageModel.fromJson(json.decode(str));

String payementSuccessPageModelToJson(PayementSuccessPageModel data) =>
    json.encode(data.toJson());

class PayementSuccessPageModel {
  PayementSuccessPageModel({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory PayementSuccessPageModel.fromJson(Map<String, dynamic> json) =>
      PayementSuccessPageModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        grandTotal: json["grand_total"] == null ? null : json["grand_total"],
         subtotalInclTax: json["subtotalInclTax"] == null ? null : json["subtotalInclTax"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "grand_total": grandTotal == null ? null : grandTotal,
         "subtotalInclTax": subtotalInclTax == null ? null : subtotalInclTax,
        "billing_address":
